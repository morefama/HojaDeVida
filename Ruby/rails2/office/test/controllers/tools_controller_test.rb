...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { description: @tool.description, name: @tool.name, price: @tool.price } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { description: @tool.description, name: @tool.name, price: @tool.price } }
